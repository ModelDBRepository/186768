...
class Network:
	...
	def set_all_conns(self):
		...
		self.pyr_bas_NM=self.set_connections(self.pyr,self.bas, "somaNMDA", 2, 1* 1.15*1.2e-3, 100)
		self.pyr_olm_NM=self.set_connections(self.pyr,self.olm, "somaNMDA", 2, 1* 1.0*0.7e-3, 10)
		self.pyr_pyr_NM=self.set_connections(self.pyr,self.pyr, "BdendNMDA",2, 1* 1*0.004e-3,  25)

		print "PYR -> X , AMPA"
		self.pyr_bas_AM=self.set_connections(self.pyr,self.bas, "somaAMPAf",2, 1* 0.3*1.2e-3,  100)
		self.pyr_olm_AM=self.set_connections(self.pyr,self.olm, "somaAMPAf",2, 1* 0.3*1.2e-3,  10)
		self.pyr_pyr_AM=self.set_connections(self.pyr,self.pyr, "BdendAMPA",2, 1* 0.5*0.04e-3, 25)
		...
		self.bas_bas_GA=self.set_connections(self.bas,self.bas, "somaGABAf",2, 1* 3*1.5*1.0e-3, 60)#new 2
		self.bas_pyr_GA=self.set_connections(self.bas,self.pyr, "somaGABAf",2, 1* 2*2*0.18e-3, 50)#new 1
		
		self.bas_olm_GA=self.set_connections(self.bas,self.olm, "somaGABAf",2, 1* 0.05*2*2*0.18e-3, 17) #addition MSJ

		print "OLM -> PYR , GABA"
		#self.olm_pyr_GA=self.set_connections(self.olm,self.pyr, "Adend2GABAs",2, 3*6.0e-3, 20)#original weight value
		self.olm_pyr_GA=self.set_connections(self.olm,self.pyr, "Adend2GABAs",2, 1* 4.0*3*6.0e-3, 20)#new weight value

                self.olm_pyr_GA=self.set_connections(self.olm,self.pyr, "Adend2GABAs",2, 1* 0.08* 4.0*3*6.0e-3, 10)#new weight value
